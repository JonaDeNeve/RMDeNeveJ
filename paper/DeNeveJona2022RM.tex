...
\PaperTitle{Hoe zal Apple's M1 chip de computer, zoals we die vandaag kennen, veranderen?}
...
Met Apple's nieuwe computer de Apple Silicon krijg je daarvan een voorbeeld. Deze nieuwe computer is niet groter dan een brooddoos. Dit is mogelijk dankzij Apple's M1 chip. Die bevat, door gebruik te maken van ARM, de meeste componenten die anders apart in de computer zitten.

\subsection{Onderzoeksvraag}

Er wordt onderzocht hoe de M1 chip de hedendaagse computer veranderen kan.
